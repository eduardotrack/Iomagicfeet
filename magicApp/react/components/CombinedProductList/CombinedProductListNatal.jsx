...
export function CombinedProductListNatal({ children, items, Slider, ...props }) {
  ...
  return (
    <div className={styles.combinedProductListWithImage__container}>
      <ToastProvider>
        {canUseModal ? (
          <ModalTrigger>
            <div className={`${styles.combinedProductListWithImage__banner} ${styles.combinedProductListNatal__banner}`}>
            ...
            <div className={`${styles.combinedProductListWithImage__item} ${styles.combinedProductListNatal__item}`} style={{ position: 'relative' }}>
              <div className={`${styles.combinedProductListWithImage__banner} ${styles.combinedProductListNatal__banner}`}>
                <img src={bannerSrc} alt="Product Preview" />
                {showButton && buttonText ? (
                  <button className={styles.combinedProductListWithImage__button}>{buttonText}</button>
...
CombinedProductListNatal.schema = {
