  ...
  return (
    <>
      {bannerPosts && bannerPosts?.length > 1 && (
        <SliderLayout
          {...sliderLayoutConfig}
          className={`${style.boxSlickBanner}`}
        >
      ...
      items: {
        ...
        properties: {
          ...
          textAlt: {
            ...
            description:
              'Adicione o texto que vai ser indexado no SEO na imagem e sera enviado para o analytics',
            type: 'string',
            default: null,
          },
        },
            ...
            oneOf: [
              {
                properties: {
                  ...
                  linkMedia: {
                    ...
                    description:
                      'Link para redirecionamento do post, caso não tenha deixar em branco.',
                    type: 'string',
                    default: null,
                  },
                },
